...
` + walk([
      ...
      ['for each n in numbers from 2 onwards', '<b>A list that does not exist yet.</b> A stream hands over one item at a time - a hundred million numbers cost nothing until read, and an endless one is ended by <b>stop</b>. <b>the first 10 of</b> makes any stream a list again.'],
      ['make job be start working on "grind" with 3000000', '<b>Work done elsewhere.</b> A separate process loads only your definitions and runs one action with one value; <b>the answer of job</b> waits for it. Two jobs started together really do run on two processors.'],
