...
int main(void) {
    ...
    fprintf(stderr, "line 32: plain_enter(&frame);\n");
    plain_enter(&frame);
    fprintf(stderr, "line 33: plain_local(&frame, &list);\n");
    plain_local(&frame, &list);

    /* Enough to prove the runtime holds together and agrees with Plain. */
    fprintf(stderr, "line 36: plain_say(plain_add(plain_number_value(0\n");
    plain_say(plain_add(plain_number_value(0.1), plain_number_value(0.2)));
    fprintf(stderr, "line 37: plain_say(plain_divide(plain_number_valu\n");
    plain_say(plain_divide(plain_number_value(10), plain_number_value(4)));

    fprintf(stderr, "line 39: plain_keep(&list, plain_list_of(3, plain\n");
    plain_keep(&list, plain_list_of(3, plain_number_value(3), plain_number_value(1), plain_number_value(2)));
    fprintf(stderr, "line 40: plain_say(plain_sorted(list));\n");
    plain_say(plain_sorted(list));
    fprintf(stderr, "line 41: plain_say(plain_item(list, plain_number_\n");
    plain_say(plain_item(list, plain_number_value(1)));
    fprintf(stderr, "line 42: plain_say(plain_join_with(list, plain_te\n");
    plain_say(plain_join_with(list, plain_text_value("-")));
    fprintf(stderr, "line 43: plain_say(plain_part(plain_text_value('H\n");
    plain_say(plain_part(plain_text_value("Hello, World"), plain_number_value(1), plain_number_value(5)));

    fprintf(stderr, "line 45: plain_push_catch(&spot);\n");
    plain_push_catch(&spot);
    fprintf(stderr, "line 46: if (setjmp(spot.jump) == 0) {\n");
    if (setjmp(spot.jump) == 0) {
    ...
    fprintf(stderr, "line 54: plain_sweep(&frame);\n");
    plain_sweep(&frame);
    fprintf(stderr, "line 55: plain_leave(&frame, plain_nothing());\n");
    plain_leave(&frame, plain_nothing());
    fprintf(stderr, "line 56: plain_done();\n");
    plain_done();
    fprintf(stderr, "line 57: return 0;\n");
    return 0;
}
